...
export default function Footer({ onNavigate }: FooterProps) {
  ...
  return (
    <footer className="bg-slate-950 pt-16 pb-12 text-left text-slate-500 border-t border-slate-850">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="flex items-center space-x-2.5 cursor-pointer group" onClick={() => onNavigate('hero')}>
              <div className="group-hover:scale-105 transition-transform duration-300">
                <LogoIcon size={38} className="text-amber-500" />
              </div>
              <div>
                <span className="text-lg font-black text-slate-700 tracking-tight">
                  MMB <span className="text-amber-500 font-bold">Realtors</span>
                </span>
                <span className="block text-[9px] text-slate-400 tracking-wider uppercase font-mono">
                  {t.nav.logoSubtitle}
                </span>
              </div>
            </div>
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="space-y-4">
                <h4 className="text-xs font-black uppercase font-mono tracking-wider text-slate-700">
                  ...
                  {['services', 'calculator', 'tracker', 'booking'].map((link) => (
                    <li key={link}>
                      <button
                        ...
                        className="hover:text-amber-600 transition-colors capitalize font-medium flex items-center gap-1 cursor-pointer text-slate-500"
                      >
              ...
              <div className="space-y-3.5">
                ...
                <div className="flex flex-col gap-2">
                  <a 
                    ...
                    target="_blank" 
                    rel="noreferrer" 
                    className="p-2.5 bg-slate-900 border border-slate-850 rounded-xl flex items-center justify-between text-[11px] hover:border-slate-800 hover:bg-slate-950 transition-colors text-slate-600"
                  >
        ...
        <div className="mt-12 pt-8 border-t border-slate-850 flex flex-col md:flex-row items-center justify-between gap-4 text-[10px] text-slate-400 font-mono">
